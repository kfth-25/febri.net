    ...
    return (
        <Layout>
            ...
            >
                ...
                <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, px: { xs: 4, md: 8 } }}>
                    <Grid container spacing={10} alignItems="center">
                        <Grid item xs={12} md={7} sx={{ pr: { md: 4 } }}>
                            ...
                            >
                                ...
                                >
                                    Rasakan pengalaman digital terbaik dengan koneksi fiber optic yang stabil dan super cepat. Kelola layanan Anda dalam satu genggaman.
                                </Typography>
                                <Stack
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        color="inherit"
                                        size="large"
                                        sx={{ px: 4, py: 1.5, fontSize: '1rem', borderRadius: '12px', borderColor: 'rgba(255,255,255,0.3)' }}
                                    >
                                        Daftar Sekarang
                                    </Button>
                                </Stack>
                        ...
                        <Grid item xs={12} md={5} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: { xs: 6, md: 0 } }}>
                            <PhoneMockup />
                        </Grid>
                    </Grid>
                </Container>
